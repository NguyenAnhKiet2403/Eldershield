...
const mockSpamAlerts: SpamAlert[] = [
  {
    ...
    type: "scam_message",
    description: "Cung cấp mã PIN cho tin nhắn giả mạo ngân hàng",
    time: "2 giờ trước"
  },
  {
    id: "2",
...
interface FamilyPremiumViewProps {
  onBack: () => void;
}

export function FamilyPremiumView({ onBack }: FamilyPremiumViewProps) {
